<?php
require_once '../../control/barang/proses_barang.php';
?>
                    ...
                    <div class="sidebar__content">
                        <div>
                            ...
                            <div class="sidebar__list b-bot">
                                ...
                                <a href="view_customer.php" class="sidebar__link">
            ...
            <main class="main container" id="main">
                <section class="table">
                    ...
                    <div class="table__info">
                        <h1 class="title__table">Tabel Data Barang</h1>
                        </div>
                        <div class="table__fungsi">
                                <a  data-fungsi="add" href="../form/form_add.php?tabel=barang" class="add-btn"><i class="fa-solid fa-plus"></i></a>
